...
char *
base64url_encode(const unsigned char *src, int len, int pad)
{
    const char encoding_table[64] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";
...
unsigned char *
base64url_decode(const unsigned char *src, int len)
{
